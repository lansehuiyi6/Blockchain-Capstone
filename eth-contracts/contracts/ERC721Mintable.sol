...
contract Pausable is Ownable {
    ...
    event Paused(address senderAddress);
    event Unpaused(address senderAddress);
    ...
    function unpauseContract() public paused {
        _paused = false;
...
contract ERC721 is Pausable, ERC165 {
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        if(_exists(tokenId)) {
            revert("tokenId already exists or given address is invalid");
        }
